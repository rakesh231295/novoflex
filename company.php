...
<main class="page-shell company-page company-page-refresh">
  ...
  <section class="page-section" id="usp">
    <div class="container">
      ...
      <div class="row g-4">
        <div class="col-md-6 col-xl-4">
          <div class="content-card h-100 company-usp-card company-usp-card-c1">
        ...
        <div class="col-md-6 col-xl-4">
          <div class="content-card h-100 company-usp-card company-usp-card-c2">
            <div class="company-usp-meta">
        ...
        <div class="col-md-6 col-xl-4">
          <div class="content-card h-100 company-usp-card company-usp-card-c3">
            <div class="company-usp-meta">
        ...
        <div class="col-md-6 col-xl-4">
          <div class="content-card h-100 company-usp-card company-usp-card-c4">
            <div class="company-usp-meta">
        ...
        <div class="col-md-6 col-xl-4">
          <div class="content-card h-100 company-usp-card company-usp-card-c5">
            <div class="company-usp-meta">
        ...
        <div class="col-md-6 col-xl-4">
          <div class="content-card h-100 company-usp-card company-usp-card-c6">
            <div class="company-usp-meta">
