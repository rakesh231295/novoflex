...
<main class="industries-page" style="padding-top: 180px; padding-bottom: 80px; background-color: #f8fafc;">
  <div class="container">
    <div class="text-center mb-5">
      ...
      <h1 style="color: #071e43; font-weight: 800; font-size: 40px; margin-bottom: 20px;">Industry Solutions We Support</h1>
      <p style="color: #52637a; font-size: 16px; max-width: 600px; margin: 0 auto; line-height: 1.6;">
        Explore our comprehensive range of cable management solutions engineered for diverse critical industrial applications.
      </p>
    </div>
